...
compose.desktop {
    application {
        ...
        nativeDistributions {
            ...
            packageName = "guillaama"
            packageVersion = appPackageVersion

            linux{
                shortcut = true
                iconFile.set(project.file("icons/linux.png"))
                description = "GUI app to handle & chat with locaal ollama models"
            }
...
compose.resources{
    ...
    packageOfResClass = "guillaama.resources"
...
val appDisplayName = "GUILLAMA"
val mainClass = "GUILLAMA"
val maintainer = "Zahid Khalilov <halilzahid@gmail.com>"
val controlDescription = "GUI app to handle & chat with locaal ollama models"
